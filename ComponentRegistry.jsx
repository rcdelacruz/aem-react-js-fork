...
var ComponentRegistry = (function () {
    ...
    ComponentRegistry.prototype.register = function (componentClass) {
        ...
        this.mappings.push(new RootComponentRegistry_1.Mapping(resourceType, componentClass, false));
    };
    ComponentRegistry.prototype.registerVanilla = function (config) {
        ...
        this.mappings.push(new RootComponentRegistry_1.Mapping(resourceType, wrapperClass, true));
    };

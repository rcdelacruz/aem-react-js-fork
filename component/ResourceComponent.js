...
var ResourceComponent = (function (_super) {
    ...
    ResourceComponent.prototype.render = function () {
        ...
        return (React.createElement(EditDialog_1.default, { path: this.getPath(), resourceType: this.getResourceType(), className: this.props.className }, child));
    };
    ...
    ResourceComponent.prototype.renderChildren = function (path, childClassName, childElementName) {
        ...
        Object.keys(children).forEach(function (nodeName, childIdx) {
            ...
            if (childElementName) {
                ...
                if (componentType) {
                    ...
                    childComponents.push(React.createElement(include_1.ResourceInclude, { path: actualPath, key: nodeName, resourceType: resourceType }));
                }
            }
        }, this);
        var newZone = null;
        if (this.isWcmEnabled()) {
            ...
            newZone = React.createElement(include_1.ResourceInclude, { key: "newZone", element: "div", path: "*", resourceType: resourceType });
